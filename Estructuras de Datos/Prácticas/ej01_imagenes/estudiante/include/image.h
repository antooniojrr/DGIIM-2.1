...
public :
    ...
    /**
      * @brief Invierte la escala de grises de la imagen
      * @post La imagen sobre la que trabajamos queda invertida
      */
    void Invert();
    ...
    /**
      ...
      * @param i Umbral inferior de la imagen de entrada.
      * @param j Umbral superior de la imagen de entrada.
      * @param height Umbral inferior de la imagen de salida.
      * @param width Umbral superior de la imagen de salida.
      * @pre 0 <= (i, j, height, width ) < nrow,ncols.
      * @returns La media de los píxeles.
      */
    ...
    /**
      ...
      * @param nrow Fila inicial donde recortar
    ...
    /**
      * @brief Realiza un zoom x2 a una imagen.
      * @pre Si no se le pasa una imagen cuadrada, el método tomará el mayor cuadrado contenido en la imagen.
      * @returns Imagen con el zoom realizado.
      * @post El objeto que llama a la función no se modifica.
      */
    Image Zoom2X() const;
    ...
    /**
      * @brief Baraja pseudoaleatoriamente las filas de una imagen. Primera de las implementaciones (Pdf)
      * @pre rows < 9973
      * @returns ninguna
      * @post El objeto que llama al método contiene ahora una nueva imagen igual que la anterior pero con las filas ordenadas según el siguiente algoritmo:
      * las filas ordenadas según el siguiente algoritmo: rnew = ( r * p ) mod rows donde p = 9973 primo
      */
    void ShuffleRows();
} ;
